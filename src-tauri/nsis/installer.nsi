; Custom NSIS template for Vozel with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\Vozel for portable
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "Vozel Portable Mode"
    FileClose $0
