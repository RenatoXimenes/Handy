{
  description = "Vozel - A free, open source, and extensible speech-to-text application that works completely offline";
  ...
  outputs =
    ...
    in
    {
      packages = forAllSystems (
        ...
        in
        {
          vozel = pkgs.rustPlatform.buildRustPackage {
            pname = "vozel";
            inherit version;
            src = self;
          ...
          default = self.packages.${system}.vozel;
        }
      );
      ...
      nixosModules.default =
        { lib, pkgs, ... }:
        {
          ...
          programs.vozel.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.vozel;
        };
      ...
      homeManagerModules.default =
        { lib, pkgs, ... }:
        {
          ...
          services.vozel.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.vozel;
        };
      ...
      devShells = forAllSystems (
        ...
        in
        {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              echo "Vozel development environment"
              bun install
